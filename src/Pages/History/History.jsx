...
import useMyWorks from '../../Hooks/useMyWorks';
import Hazira_History from './Hazira_History';
import Baton_History from './Baton_History';
import Contactor_History from './Contactor_History';
import Production_History from './Production_History';
...
console.log(onlyuser)
  return (
       ...
       <div>
       {onlyuser?.category === 'hazira' && <Hazira_History />}
    {onlyuser?.category === 'baton' && <Baton_History />}
    {onlyuser?.category === 'contactor' && <Contactor_History/>}
    {onlyuser?.category === 'protaction' && <Production_History/>}
    </div>
